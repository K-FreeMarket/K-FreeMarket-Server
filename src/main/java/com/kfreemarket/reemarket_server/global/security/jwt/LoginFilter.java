...
import com.kfreemarket.reemarket_server.domain.user.dto.LoginRequestDto;
import com.kfreemarket.reemarket_server.domain.user.entity.Refresh;
...
public class LoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    private void addRefreshEntity(String username, String refresh, Long expiredMs) {
        ...
        refreshEntity.setUser(userReposiotry.findByEmail(username).orElseThrow());
